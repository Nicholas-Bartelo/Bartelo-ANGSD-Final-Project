...
library(patchwork)
readcounts <- paste0("final_project_featCounts_mouse_genes_stranded_after_comments_from_merv.txt") %>% read.table(., header=TRUE)
```
...
plotMA(DGE.results.shrink_db_wt,alpha = 0.05, main = "DB vs WT: with logFC shrinkage", ylim =c(-4,4))
abline(h = 1, col = 'red')
abline(h = -1, col = 'red')
